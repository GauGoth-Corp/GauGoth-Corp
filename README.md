...
**GauGoth Corp.** is a personal project I created in 2021. Initially focused on developing the video game **_Mini Golf 3D: The Pirate flag_**, I later developed many other projects and content, which I share **free of charge** on my website, social media platforms, and GitHub.
...
- [**_Mini Golf 3D: The Pirate flag_**](https://gaugoth-corp.pages-perso.free.fr/en/games/) - _Unity_: a 3D mini-golf game in a realistic pirate setting. Available for free on **Windows**, **Mac**, **Linux**, **Android (Google Play)** and **WebGL**. [Play !](https://gaugoth-corp.pages-perso.free.fr/en/games/)
...
<p style="text-align: center;">
  ...
  <img alt="Visitor count" title="Visitor count" src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fgaugoth-corp.pages-perso.free.fr%2Fsrc%2Fapi%2Fbadge-counter-github.php%3FlangForced%3Dfr&query=%24.visites&label=Visits&color=3498db&cacheSeconds=300&style=for-the-badge" width="auto" height="40px">
</p>
...
- [**_Whatsapp Backup Viewer_**](https://github.com/GauGoth-Corp/WhatsApp-Backup-Viewer) - _Web Application_: a tool for viewing WhatsApp chat backups. [Download !](https://github.com/GauGoth-Corp/WhatsApp-Backup-Viewer)
- [**_Hogwarts Game_**](https://github.com/GauGoth-Corp/hogwarts-lechani-piret-int1) - _Python_: a team project of a text-based role-playing video game based on the Harry Potter universe. [Play !](https://github.com/GauGoth-Corp/hogwarts-lechani-piret-int1)
- [**_The Omicronde Project_**](https://github.com/galaxaris) - _Pygame_: a very complete platformer, developed in a team, on an environmental post-apocalyptic theme. [View the project !](https://github.com/galaxaris)
- [**_Instagram channel_**](https://www.instagram.com/gaugoth_corp/) - _Social Media_: my Instagram channel, where I share content related to my work and projects. [Follow !](https://www.instagram.com/gaugoth_corp/)
- [**_YouTube channel_**](https://www.youtube.com/@GauGoth_Corp/) - _Social Media_: the trailers of _Mini Golf 3D: The Pirate flag_. [Subscribe !](https://www.youtube.com/@GauGoth_Corp/)
- **CMS (Content Management System)** - _Web Application_: an admin project currently in development, to efficiently manage the content of my websites (articles, forum, quizzes, login, statistics, private content, banishment, etc.).
- [**_Nuit du Code_**](https://github.com/Tomate92/Pyxel_NDC_2025) - _Pyxel_: small Python games developed in teams over 8 hours for this programming contest. [2024](https://github.com/Tomate92/Pyxel_Nuit_Du_Code) | [2025](https://github.com/Tomate92/Pyxel_NDC_2025)
- **And many other projects!** _Unity_, _Python_, _C_, _JavaScript_... Do not hesitate to explore my GitHub and my website to discover them! [https://gaugoth-corp.pages-perso.free.fr/en/]()
...
If you have any questions, comments, requests or other, if you have noticed any bugs, contact me using this form: [Contact me!](https://gaugoth-corp.pages-perso.free.fr/en/credits/contact/).
